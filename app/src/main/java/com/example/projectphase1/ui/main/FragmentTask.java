...
//        //  databaseReference.child("3").setValue(new ClassJobFB("http://4.bp.blogspot.com/-raCMY1PNgiI/URPs9AZZn2I/AAAAAAAAAAg/OQnDrL2eAiA/s1600/shutterstock_13189759.jpg",3,"Cleaner",800));
...
//        databaseReference.child("13").setValue(new ClassJobFB("https://www.pinclipart.com/picdir/middle/39-394393_svg-freeuse-mathsub-com-gre-mathematics-test-preparation.png",10,"Tutor",1000));
//        databaseReference.child("14").setValue(new ClassJobFB("https://cdn.shopify.com/s/files/1/0065/4917/6438/products/male-graphic-designers-collection-001_300x300.jpg?v=1550440242",11,"Designer",1200));
//        databaseReference.child("15").setValue(new ClassJobFB("https://clipartstation.com/wp-content/uploads/2017/11/architect-clipart-6.jpg",12,"Architect",1000));
//        databaseReference.child("16").setValue(new ClassJobFB("https://library.kissclipart.com/20190227/geq/kissclipart-personal-protective-equipment-clipart-welding-work-5f23884b0252bbc2.png",9,"Welder",800));
//        databaseReference.child("17").setValue(new ClassJobFB("https://www.pinclipart.com/picdir/middle/39-394393_svg-freeuse-mathsub-com-gre-mathematics-test-preparation.png",10,"Tutor",1000));
//        databaseReference.child("18").setValue(new ClassJobFB("https://cdn.shopify.com/s/files/1/0065/4917/6438/products/male-graphic-designers-collection-001_300x300.jpg?v=1550440242",11,"Designer",1200));
//        databaseReference.child("19").setValue(new ClassJobFB("https://clipartstation.com/wp-content/uploads/2017/11/architect-clipart-6.jpg",12,"Architect",1000));
//        databaseReference.child("20").setValue(new ClassJobFB("https://www.pinclipart.com/picdir/middle/39-394393_svg-freeuse-mathsub-com-gre-mathematics-test-preparation.png",10,"Tutor",1000));
//        databaseReference.child("21").setValue(new ClassJobFB("https://cdn.shopify.com/s/files/1/0065/4917/6438/products/male-graphic-designers-collection-001_300x300.jpg?v=1550440242",11,"Designer",1200));
//        databaseReference.child("22").setValue(new ClassJobFB("https://clipartstation.com/wp-content/uploads/2017/11/architect-clipart-6.jpg",12,"Architect",1000));
//
//
//
